...
pub fn benchmark_hybrid_new_handshake(nb_iter: u32) {
    ...
    let dummy_src_addr = SocketAddr::new(IpAddr::V4(Ipv4Addr::new(127, 0, 0, 1)), 12345);
    ...
    for i in 0..nb_iter {
        ...
        dev1.release(ks_i.recv.id);
        dev2.release(ks_r.recv.id);
